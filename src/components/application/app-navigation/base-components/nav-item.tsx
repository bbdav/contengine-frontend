...
const styles = sortCx({
    root: "group relative flex w-full cursor-pointer items-center rounded-md outline-focus-ring transition duration-100 ease-linear select-none hover:bg-quaternary focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-offset-2",
